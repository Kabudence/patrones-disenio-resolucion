...
function main(){
    ...
    pokedex.addPokemon(new Pokemon('volton','electric'));
    pokedex.addPokemon(new Pokemon('elekid','electric'));
    pokedex.addPokemon(new Pokemon('electibier','electric'));
    pokedex.addPokemon(new Pokemon('charmnader','fire'));
